...
class DatabaseWrapper:
    ...
    def get_evento_by_id(self, id):
        return self.fetch_query("SELECT * FROM eventi WHERE id = %s", (id,))
    ...
    def get_eventi_per_organizzatore(self, org_id):
        return self.fetch_query("SELECT * FROM eventi WHERE organizzatore_id = %s", (org_id,))
